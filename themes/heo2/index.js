...
// 主题全局变量
const ThemeGlobalHeo2 = createContext()
export const useHeo2Global = () => useContext(ThemeGlobalHeo2)
...
const LayoutBase = props => {
  const { children, slotTop, className, allNavPages } = props
