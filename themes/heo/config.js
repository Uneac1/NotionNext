const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-06-12', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://ows.y130.icu' },
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '消耗品',
  HEO_HERO_TITLE_2: '所有的男人都是',
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '精选', url: '/tag/必看精选' },
  HEO_HERO_CATEGORY_2: { title: '热门', url: '/tag/热门文章' },
  HEO_HERO_CATEGORY_3: { title: '教程', url: '/tag/实用教程' },
  ...
  HEO_GROUP_ICONS: [
    ...
    {
      title_1: 'FinalCutPro',
      img_1: '/images/heo/70013.png',
      color_1: '#ffffff',
      title_2: 'Python',
      img_2: '/images/heo/70005.png',
      color_2: '#ffffff'
    },
    {
      title_1: 'Swift',
      img_1: '/images/heo/70011.png',
      color_1: '#eb6840',
      title_2: 'Principle',
